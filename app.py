...
def main():
    ...
    # Custom rocket emoji cursor (SVG data URI)
    rocket_cursor = "url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"32\" height=\"32\" viewBox=\"0 0 32 32\"><text y=\"26\" font-size=\"28\">🚀</text></svg>') 0 24, auto"
